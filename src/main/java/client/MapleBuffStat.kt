...
enum class MapleBuffStat(override val value: Int, override val position: Int) : Serializable, Buffstat {
    WATK(0x1, 4),
    WDEF(0x2, 4),
    MATK(0x4, 4),
    MDEF(0x8, 4),
    ...
    UNKNOWN3(0x10000, 3),
    GHOST_MORPH(0x20000, 3), // Ghost
    ARIANT_COSS_IMU(0x40000, 3), // Shield
    REVERSE_DIR(0x80000, 3),
    UNKNOWN6(0x400000, 3),
    UNKNOWN7(0x800000, 3),
    UNKNOWN8(0x1000000, 3),
    BERSERK_FURY(0x2000000, 3),
    DIVINE_BODY(0x4000000, 3),
