...
stamp = "① ② ③ ④ ⑤ ⑥ ⑦ ⑧ ⑨ ⑩";
	...
	if (status == 0) {
		...
		cm.sendSimple("출석체크 메뉴를 선택하셨습니다. 오늘도 저희 needfix에 방문해주셔서 감사합니다. 매일매일 출석체크를 하시는 유저분들을 대상으로 작은 사은품을 준비했습니다.\r\n\r\n현재 나의 출석 현황 : "+stamp+"\r\n다음 출석체크까지 남은 시간 : "+cancheck+" \r\n#b#L0#지금 출석체크를 하고 싶습니다. #l\r\n#L1#오늘의 사은품을 받고 싶습니다. #l");
	 	status++;
		} else {
		...
		if (selection == 0) {
			if(checkTime() < 0) {
				...
				cm.sendOk("#e#r오늘의 출석체크가 완료되었습니다!#k#n\r\n\r\n오늘도 저희 needfix에 방문해주셔서 감사합니다. 항상 저희 서버를 즐겨주시는 "+cm.getPlayer().getName()+"님께 #b출석포인트#k를 적립해드렸습니다. 다시 저를 눌러 사은품을 찾아가시기 바랍니다.");
			...
			if (point == 1) {
				...
				cm.sendOk("언제나 저희 needfix를 사랑해주셔서 감사합니다 저희들의 작은 선물이 맘에드실지는 모르겠네요! 앞으로도 많은 사랑과 관심 부탁드리며 더욱더 발전하는 needfix이 되겠습니다 감사합니다.\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#\r\n#i5076000# #b아이템 확성기 50개를 획득하였습니다.");
				cm.dispose();
			} else if (point == 2) {
				PrizeCheck.setCustomData("받음");	
